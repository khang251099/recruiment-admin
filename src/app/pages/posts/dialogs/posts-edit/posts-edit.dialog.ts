...
export class PostsEditDialog implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formUpdate = this.fb.group({
      ...
      expired: [this.postsData.expired, Validators.required]
    })
  }
  ...
  onUpdate() {     
    ...
    formData.append('expired', this.formUpdate.value.expired.toLocaleDateString());    
    ...
    this.postsService.updateAll(id, {_method: 'put'}, formData).subscribe(res => {
      console.log(res);
